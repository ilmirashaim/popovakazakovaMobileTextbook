...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        // get custom attrs
        a = context.obtainStyledAttributes(attrs, R.styleable.SlidingTabLayout);
        indicatorColor = a.getColor(R.styleable.SlidingTabLayout_pstsIndicatorColor, indicatorColor);
        underlineColor = a.getColor(R.styleable.SlidingTabLayout_pstsUnderlineColor, underlineColor);
        dividerColor = a.getColor(R.styleable.SlidingTabLayout_pstsDividerColor, dividerColor);
        dividerWidth = a.getDimensionPixelSize(R.styleable.SlidingTabLayout_pstsDividerWidth, dividerWidth);
        indicatorHeight = a.getDimensionPixelSize(R.styleable.SlidingTabLayout_pstsIndicatorHeight, indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(R.styleable.SlidingTabLayout_pstsUnderlineHeight, underlineHeight);
        dividerPadding = a.getDimensionPixelSize(R.styleable.SlidingTabLayout_pstsDividerPadding, dividerPadding);
        tabPadding = a.getDimensionPixelSize(R.styleable.SlidingTabLayout_pstsTabPaddingLeftRight, tabPadding);
        tabBackgroundResId = a.getResourceId(R.styleable.SlidingTabLayout_pstsTabBackground, tabBackgroundResId);
        shouldExpand = a.getBoolean(R.styleable.SlidingTabLayout_pstsShouldExpand, shouldExpand);
        scrollOffset = a.getDimensionPixelSize(R.styleable.SlidingTabLayout_pstsScrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(R.styleable.SlidingTabLayout_pstsTextAllCaps, textAllCaps);
        isPaddingMiddle = a.getBoolean(R.styleable.SlidingTabLayout_pstsPaddingMiddle, isPaddingMiddle);
        tabTypefaceStyle = a.getInt(R.styleable.SlidingTabLayout_pstsTextStyle, Typeface.BOLD);
        tabTypefaceSelectedStyle = a.getInt(R.styleable.SlidingTabLayout_pstsTextSelectedStyle, Typeface.BOLD);
        tabTextColorSelected = a.getColorStateList(R.styleable.SlidingTabLayout_pstsTextColorSelected);
        textAlpha = a.getInt(R.styleable.SlidingTabLayout_pstsTextAlpha, textAlpha);
        a.recycle();
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof CustomTabProvider) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(R.layout.main_tab, this, false);
            }
